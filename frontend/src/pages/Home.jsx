                    ...
                    <form className='search-form'>
                        <div className='search-by-year'>
                            ...
                            <div class="input__container input__container--variant">
                                ...
                                <input type="number" name="text" class="input__search input__search--variant" onChange={(e) => setSearch(e.currentTarget.value)} placeholder="Search by Year" />
                                <button class="input__button__shadow input__button__shadow--variant" onClick={searchByYear}>
